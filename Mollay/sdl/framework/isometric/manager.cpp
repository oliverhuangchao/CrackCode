...
Manager::Manager() :
  ...
  orbSurface( io.loadAndSet(Gamedata::getInstance().getXmlStr("greenorbFile"), 
              Gamedata::getInstance().getXmlBool("greenorbTransparency")) ),
...
void Manager::update() {
  ...
  if ( makeVideo && frameCount < frameMax ) {
    ...
    strm << "video/image" << frameCount++ << ".bmp";
