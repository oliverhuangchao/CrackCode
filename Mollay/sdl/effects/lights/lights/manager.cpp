...
Manager::Manager() :
  ...
  redSurface( io.loadAndSet(gdata->getXmlStr("redorbFile"), 
                gdata->getXmlBool("redorbTransparency")) ),
  yellowSurface( io.loadAndSet(gdata->getXmlStr("yelloworbFile"),
                gdata->getXmlBool("yelloworbTransparency")) ),
  ...
  yelloworbFrame(new Frame(yellowSurface,
                ...
                gdata->getXmlInt("yelloworbHeight"), 
                gdata->getXmlInt("yelloworbSrcX"), 
                gdata->getXmlInt("yelloworbSrcY")) 
  ),
  orbs(),
  currentOrb(0),
  lights()
{
  ...
  orbs.reserve(2);
  orbs.push_back( Sprite("yelloworb", yelloworbFrame) );
  orbs.push_back( Sprite("redorb", redorbFrame) );
